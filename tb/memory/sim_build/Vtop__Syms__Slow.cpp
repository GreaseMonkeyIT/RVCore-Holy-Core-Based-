    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_memory__unnamedblk2 = new VerilatedScope{this, "memory.unnamedblk2", "unnamedblk2", "<null>", -9, VerilatedScope::SCOPE_OTHER};
    // Set up scope hierarchy
    __Vhier.add(0, __Vscopep_memory);
    __Vhier.add(__Vscopep_memory, __Vscopep_memory__unnamedblk1);
    __Vhier.add(__Vscopep_memory, __Vscopep_memory__unnamedblk2);
    // Setup export functions - final: 0
    // Setup export functions - final: 1
    // Setup public variables
    __Vscopep_TOP->varInsert("address", &(TOP.address), false, VLVT_UINT32, VLVD_IN|VLVF_PUB_RW, 0, 1 ,31,0);
    __Vscopep_TOP->varInsert("byte_enable", &(TOP.byte_enable), false, VLVT_UINT8, VLVD_IN|VLVF_PUB_RW, 0, 1 ,3,0);
    ...
    __Vscopep_memory->varInsert("byte_enable", &(TOP.memory__DOT__byte_enable), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    __Vscopep_memory->varInsert("clk", &(TOP.memory__DOT__clk), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 0);
    __Vscopep_memory->varInsert("mem", &(TOP.memory__DOT__mem), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 1, 1 ,0,127 ,31,0);
    ...
    __Vscopep_memory__unnamedblk2->varInsert("i", &(TOP.memory__DOT__unnamedblk2__DOT__i), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW|VLVF_DPI_CLAY|VLVF_SIGNED, 0, 1 ,31,0);
}
...
Vtop__Syms::~Vtop__Syms() {
    ...
    __Vhier.remove(__Vscopep_memory, __Vscopep_memory__unnamedblk2);
    ...
    VL_DO_CLEAR(delete __Vscopep_memory__unnamedblk2, __Vscopep_memory__unnamedblk2 = nullptr);
